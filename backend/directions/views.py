...
class FactsAPIView(APIView):
    ...
    def post(self, request):
        ...
        InputMessage = f"Напиши 4 небольших факта о городе {direction} в Индии. Ответ выдавай строго в одну строку в таком формате с разделителем |, вот так:  тема факта 1|первый факт|тема факта 2|второй факт и тд"
